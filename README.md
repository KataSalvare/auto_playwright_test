...
产品选择完成后等待 1–3 秒停止录像，浏览器继续监控 `success`。成功视频输出到：
...
自动化浏览器固定模拟 iPhone 15，页面和录像尺寸均为 `393×852`。
...
11. 触发产品弹窗后随机等待 1–3 秒，选择基础版或升级版产品，再等待 1–3 秒停止录像
...
5. 触发产品弹窗后随机等待 1–3 秒，选择基础版或升级版产品，再等待 1–3 秒停止录像
